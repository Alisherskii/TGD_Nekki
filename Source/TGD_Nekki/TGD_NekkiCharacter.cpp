...
ATGD_NekkiCharacter::ATGD_NekkiCharacter()
{
...
void ATGD_NekkiCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ATGD_NekkiCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATGD_NekkiCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATGD_NekkiCharacter::Look);
		EnhancedInputComponent->BindAction(MeleeAttackAction, ETriggerEvent::Triggered, this, &ATGD_NekkiCharacter::DoMeleeAttack);
	}
	else
	{
...
void ATGD_NekkiCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATGD_NekkiCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
